...
interface ICssIconProps extends React.SVGProps<SVGSVGElement> {}

export const CssIcon: React.FC<ICssIconProps> = React.memo((props) => {
  return (
    <svg
      className="w-5 h-5"
      fill="none"
      ...
      {...props}
    >
      <path fill="#2196f3" d="M32 0l40.8 460.8L256 512l183.136-51.168L480 0z" />
      <path
        fill="#fafafa"
